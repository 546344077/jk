...
<div class="PositionFrame_black" id="PositionFrame"></div>
	...
	<a id="memos"  style="cursor:pointer;" href="${ctx}/fmain1.action" target="_top" title="点击切换到系统首页"><div id="memo" class="memo" title="点击切换到系统首页"></div></a>
...
onclick="top.location.href='fmain1.action';linkHighlightMenu(this);">系统首页</span><span id="tm_separator"></span><span id="topmenu" 
