...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${ctx}/export/update','_self');">确定</a></li>
    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" name="CUSTOMER_CONTRACT" value="${obj.CUSTOMER_CONTRACT}"/></td>
	            <td class="columnTitle_mustbe">制单日期：</td>
	            <td class="tableContent">
	            	<input type="text" name="INPUT_DATE" style="width:90px;" value="<fmt:formatDate value="${obj.INPUT_DATE}" pattern="yyyy-MM-dd"/>"
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" name="SHIPMENT_PORT" value="${obj.SHIPMENT_PORT}"/></td>
	            <td class="columnTitle_mustbe">运输方式：</td>
		            <td class="tableContentAuto">
	            	<input type="radio" name="TRANSPORT_MODE" value="SEA" class="input" <c:if test="${obj.TRANSPORT_MODE=='SEA'}">checked</c:if>>海运(SEA)
	            	<input type="radio" name="TRANSPORT_MODE" value="AIR" class="input" <c:if test="${obj.TRANSPORT_MODE=='AIR'}">checked</c:if>>空运(AIR)
	            </td>	
	        <tr>
	            <td class="columnTitle_mustbe">价格条件：</td>
	            <td class="tableContent"><input type="text" name="PRICE_CONDITION" value="${obj.PRICE_CONDITION}"/></td>
	        </tr>
	        <tr>
